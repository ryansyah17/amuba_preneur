class PeminatTeamRequestData {
  PeminatTeamRequestData({
    this.success,
    this.teamPeminatRequest,
    this.teamPeminatRequestTotal,
  });
  late final bool? success;
  late final List<TeamPeminatRequest>? teamPeminatRequest;
  late final int? teamPeminatRequestTotal;

  PeminatTeamRequestData.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    teamPeminatRequest = List.from(json['team_peminat_request'])
        .map((e) => TeamPeminatRequest.fromJson(e))
        .toList();
    teamPeminatRequestTotal = json['team_peminat_request_total'];
  }

  Map<String, dynamic> toJson() {
    final _data = <String, dynamic>{};
    _data['success'] = success;
    _data['team_peminat_request'] =
        teamPeminatRequest!.map((e) => e.toJson()).toList();
    _data['team_peminat_request_total'] = teamPeminatRequestTotal;
    return _data;
  }
}

class TeamPeminatRequest {
  TeamPeminatRequest({
    required this.id,
  ...
  TeamPeminatRequest.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    teamId = json['team_id'];
