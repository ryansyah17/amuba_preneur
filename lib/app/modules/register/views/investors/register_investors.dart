...
class RegisterInvestors extends GetView<RegisterController> {
  RegisterInvestors({super.key});
                    ...
                    children: [
                      ...
                      IntlPhoneField(
                        ...
                        onCountryChanged: (country) {
                          countryDial.value = "+${country.dialCode}";
                        },
                        style: GoogleFonts.poppins(
                            fontSize: 10.sp, color: Colors.white),
                        decoration: InputDecoration(
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          if (controller.firstNameController.text.isEmpty) {
                            ...
                            authController.cekAkunInvestor(
                                username, nohp, email);
                          }
                        },
                        child: SizedBox(
...
String emailStatus = '';
void sendAktivasiEmailInvestor(String email, String kodeOtp) async {
...
String generateOTPInvestor(int length) {
