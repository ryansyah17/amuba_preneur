...
class DetailPengumumanInvestors extends StatelessWidget {
  final String id;
  DetailPengumumanInvestors({super.key, required this.id});
  final HomeController homeController = Get.put(HomeController());
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Obx(() {
        if (homeController.newsDetailInvestor.value.success == true) {
          var pengumumanDetail = homeController.newsDetailInvestor.value.news;
          return Container(
            width: 100.w,
            height: 100.h,
            color: abuabu,
