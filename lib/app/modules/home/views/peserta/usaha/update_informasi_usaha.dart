...
class UpdateInformasiUsaha extends StatefulWidget {
  final String id;
  ...
  final String emailUsaha;
  final String nomorHpUsaha;
  UpdateInformasiUsaha({
    ...
    required this.nomorHpUsaha,
    required this.id,
  });

  @override
  State<UpdateInformasiUsaha> createState() => _UpdateInformasiUsahaState();
}

class _UpdateInformasiUsahaState extends State<UpdateInformasiUsaha> {
  final HomeController homeController = Get.put(HomeController());
  @override
  void initState() {
    super.initState();
    homeController.namaTeamController.text = widget.namaUsaha;
    homeController.selectedJenisUsaha.value = widget.jenisUsaha;
    homeController.selectedSektorUsaha.value = widget.sektorUsaha;
    homeController.deskripsiTeamController.text = widget.deskripsiUsaha;
    homeController.emailBisnisTeamController.text = widget.emailUsaha;
    homeController.nomorHpBisnisTeamController.text = widget.nomorHpUsaha;
  }
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                        ...
                        child: ClipRRect(
                          ...
                          child: Obx(
                            () => homeController.image.value == null
                                ? Image.network(
                                    homeController
                                        .informasiUsaha.value.team!.logoUrl,
                                    fit: BoxFit.cover,
                                  )
                                : Image.file(
                  ...
                  // TextFormField(
                  //   controller: homeController.linkVideoTeamController,
                  //   keyboardType: TextInputType.name,
                  //   autofocus: false,
                  //   textInputAction: TextInputAction.next,
                  //   style: GoogleFonts.poppins(fontSize: 10.sp, color: hitam),
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          if (namaTeam.isEmpty &&
                            ...
                            homeController.updateInformasiUsaha(
                                namaTeam: namaTeam,
